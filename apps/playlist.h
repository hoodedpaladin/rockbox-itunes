...
#define PLAYLIST_COMMAND_LETTER_PLAYLIST 'P'
#define PLAYLIST_COMMAND_LETTER_ADD 'A'
#define PLAYLIST_COMMAND_LETTER_QUEUE 'Q'
#define PLAYLIST_COMMAND_LETTER_DELETE 'D'
#define PLAYLIST_COMMAND_LETTER_SHUFFLE 'S'
#define PLAYLIST_COMMAND_LETTER_UNSHUFFLE 'U'
#define PLAYLIST_COMMAND_LETTER_RESET 'R'
#define PLAYLIST_COMMAND_LETTER_CLEAR 'C'
#define PLAYLIST_COMMAND_LETTER_COMMENT '#'
...
enum {
    ...
    PLAYLIST_SORT_COALLESCE_ALBUMS,
    PLAYLIST_SORT_ORGANIZE_ALBUMS,
};
